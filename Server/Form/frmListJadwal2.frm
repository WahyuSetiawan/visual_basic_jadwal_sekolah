...
'    rs!waktumulai = CStr(Format(DTPickerWaktuMulai.value, "HH:mm:ss"))
'    rs!waktuselesai = CStr(Format(DTPickerWaktuSelesai.value, "HH:mm:ss"))
    rs!waktumulai = dateToSeconds(DTPickerWaktuMulai.value)
    rs!waktuselesai = dateToSeconds(DTPickerWaktuSelesai.value)
    rs.Update
...
Sub ListJadwal(parameter As String)
    With Me.lstJadwal
        ...
        query = query & " and jadwal.id like '%" + Trim$(parameter) + "%' and tahun = '" & Trim$(cmbTahunPelajaran.Text) & "' and semester.nama = '" + Trim$(cmbSemester.Text) + "'  and jadwal.deleted = 0 and guru.deleted = 0 and pelajaran.deleted = 0"
        ...
        If Not rs.EOF Then
            ...
            Do While Not rs.EOF
                ...
                List.ListSubItems.Add , , secondToDate(rs.Fields("waktumulai"))
                List.ListSubItems.Add , , secondToDate(rs.Fields("waktuselesai"))
...
Private Sub cmdCariDataJadwal_Click()
