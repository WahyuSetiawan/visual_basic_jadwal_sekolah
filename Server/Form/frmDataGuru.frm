...
Private Sub ListView1_DblClick()
    ...
    Load frmListJadwal
    frmListJadwal.lblIdGuru = ListView1.SelectedItem.SubItems(1)
    frmListJadwal.txtGuru.Text = ListView1.SelectedItem.SubItems(1) + " - " + ListView1.SelectedItem.SubItems(2)
    frmListJadwal.Show
    Unload Me
End Sub
