...
Begin VB.Form frmLaporanDataPelajaran 
   Caption         =   "Laporan Data Pelajaran"
   ClientHeight    =   7695
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9525
   ...
   End
End
Attribute VB_Name = "frmLaporanDataPelajaran"
...
Private Sub cmdCetakSemua_Click()
    With DataEnvironmentGuru.rsCommandPelajaran
        If Not .State = 0 Then .Close
        DataEnvironmentGuru.CommandPelajaran
        ReportPelajaran.Show , Me
    End With
End Sub
