...
Begin VB.Form frmLaporanDataKelas 
   ...
   End
End
Attribute VB_Name = "frmLaporanDataKelas"
...
Private Sub cmdCetakSemua_Click()
    With DataEnvironmentGuru.rsCommandKelas
        If Not .State = 0 Then .Close
        DataEnvironmentGuru.CommandKelas
        ReportKelas.Show , Me
    End With
End Sub
