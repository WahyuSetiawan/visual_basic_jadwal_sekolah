...
Private Sub ListView1_DblClick()
    ...
    Load frmListJadwal
    frmListJadwal.lblIDKelas = ListView1.SelectedItem.SubItems(1)
    frmListJadwal.txtKelas.Text = ListView1.SelectedItem.SubItems(1) + " - " + ListView1.SelectedItem.SubItems(2)
    frmListJadwal.Show
    Unload Me
End Sub
